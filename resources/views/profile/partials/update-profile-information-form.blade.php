<section class="relative rounded-3xl border border-white/15 bg-white/10 backdrop-blur-xl shadow-xl overflow-hidden">
    ...
    @if (session('status') === 'profile-updated' || session('status') === 'verification-link-sent')
        <div
            ...
            style="display:none;"
        >
            <div class="rounded-2xl border border-white/15 bg-white/15 backdrop-blur-xl shadow-2xl px-4 py-3 w-[320px] max-w-[calc(100vw-2.5rem)]">
                <div class="flex items-start gap-3">
                    <div class="shrink-0 h-10 w-10 rounded-2xl bg-emerald-400/15 border border-emerald-300/20 flex items-center justify-center">
