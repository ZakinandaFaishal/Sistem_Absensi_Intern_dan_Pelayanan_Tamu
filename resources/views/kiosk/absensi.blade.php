    ...
    <div class="relative min-h-[65vh] flex items-center justify-center">
        ...
        <div class="relative w-full max-w-sm space-y-4">
            ...
            <div class="text-center space-y-1.5">
                <div class="mx-auto inline-flex h-10 w-10 items-center justify-center rounded-xl
                ...
                <div class="mx-auto mt-2 h-[1.5px] w-16 rounded-full bg-gradient-to-r
                            from-transparent via-white/40 to-transparent"></div>
            </div>

            {{-- Glass Card --}}
            <section class="relative rounded-2xl border border-white/20
                            bg-white/10 backdrop-blur-xl shadow-lg p-4">

                {{-- subtle highlight --}}
                <div class="pointer-events-none absolute inset-0 bg-gradient-to-br
                            from-white/10 via-transparent to-transparent rounded-2xl"></div>
                ...
                <div class="relative flex flex-col items-center gap-3">
                    ...
                    {{-- Info --}}
                    <div class="w-full rounded-xl border border-white/15
                        ...
                        <div class="text-[11px] text-white/70 break-all leading-snug">
                            <div>
                                URL:
                                <span id="kiosk-scan-url"
                                      class="font-mono text-white/90"></span>
                            </div>
                            <div>
                                Berlaku:
                                <span id="kiosk-expires"
