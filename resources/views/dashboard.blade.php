<x-app-layout>
    ...
    <div class="relative min-h-screen overflow-hidden py-10
        ...
        <div class="relative max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="relative overflow-hidden rounded-3xl border border-slate-200/60 bg-white/45 backdrop-blur-xl shadow-lg shadow-slate-900/5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                ...
                >
                    ...
                    <div class="relative p-5">
                        ...
                        <div class="mt-5 inline-flex items-center rounded-xl bg-slate-900 px-4 py-2 text-xs font-semibold text-white">
                            Lihat Log →
                        </div>
                    </div>
                </a>
                ...
                >
                    ...
                    <div class="relative p-5">
                        <div class="flex items-start justify-between">
                            <div class="inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-emerald-600/10 ring-1 ring-inset ring-emerald-200/70">
                                📝
                            </div>
                        ...
                        <div class="mt-5 inline-flex items-center rounded-xl bg-emerald-700 px-4 py-2 text-xs font-semibold text-white">
                            Lihat Data →
                        </div>
                    </div>
                </a>
                ...
                >
                    ...
                    <div class="relative p-5">
                        ...
                        <div class="mt-5 inline-flex items-center rounded-xl bg-sky-700 px-4 py-2 text-xs font-semibold text-white">
                            Lihat Survey →
                        </div>
                    </div>
                </a>
                ...
                >
                    ...
                    <div class="relative p-5">
                        ...
                        <div class="mt-5 inline-flex items-center rounded-xl bg-fuchsia-700 px-4 py-2 text-xs font-semibold text-white">
                            Kelola User →
                        </div>
                    </div>
                </a>
