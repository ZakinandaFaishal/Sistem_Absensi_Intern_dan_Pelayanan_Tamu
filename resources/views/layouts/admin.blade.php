...
<div class="h-screen">
    ...
    >
        <div class="flex h-full flex-col">
            ...
            <div class="h-16 px-6 flex items-center gap-3 border-b border-white/10 relative shrink-0">
            ...
            <nav class="flex-1 overflow-y-auto px-4 py-5 space-y-4">
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <a href="{{ route('kiosk.display') }}"
                        class="rounded-2xl border border-white/10 bg-white/5 px-3 py-3 text-xs font-semibold
                               hover:bg-white/10 transition flex items-center gap-2">
                        <span class="text-sm">🖥️</span> Kiosk
                    </a>
                </div>
            ...
            {{-- Footer sidebar (TETAP DI BAWAH, TIDAK SCROLL) --}}
    ...
    {{-- MAIN --}}
    <div class="h-screen flex flex-col lg:pl-[280px]">
