...
<body x-data="{ sidebarOpen: false }" @keydown.escape.window="sidebarOpen = false"
    ...
    <div class="h-screen overflow-hidden">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'"
            class="fixed left-0 top-0 z-50 w-[280px] h-screen
                ...
                <nav class="flex-1 overflow-y-auto px-4 py-5 space-y-4">
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <a href="{{ route('kiosk.display') }}"
                            class="rounded-2xl border border-white/10 bg-white/5 px-3 py-3 text-xs font-semibold
                               hover:bg-white/10 transition flex items-center gap-2">
                            <x-icon name="computer-desktop" class="h-5 w-5" /> Kiosk
                        </a>
                    </div>
        ...
        <div class="h-screen flex flex-col md:pl-[280px]">
            ...
            {{-- TOPBAR --}}
            <header
                class="h-16 bg-white border-b border-slate-200 px-4 sm:px-6 flex items-center justify-between shrink-0">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('kiosk.display') }}" target="_blank" rel="noopener"
                        ...
                        <x-icon name="computer-desktop" class="h-5 w-5" /> Buka Mode Kiosk
                    </a>
