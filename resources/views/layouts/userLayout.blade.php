    ...
    <div class="h-[100dvh] w-full overflow-hidden">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full sm:translate-x-0'"
            ...
            <div class="flex h-full flex-col">
                ...
                <<<<<<< HEAD {{-- Brand --}} <div
                    class="relative h-16 shrink-0 px-5 flex items-center gap-3 border-b border-white/15">
                    <div
                        class="h-9 w-9 rounded-2xl bg-white/20 border border-white/10 flex items-center justify-center overflow-hidden">
                        ...
                        <div class="h-16 px-5 flex items-center gap-3 border-b border-white/15 shrink-0 relative">
                            <div
                                class="h-9 w-9 rounded-xl bg-white/20 flex items-center justify-center overflow-hidden">
                                <img src="{{ asset('img/logo_kab_mgl.png') }}" class="h-6 w-6 object-contain"
                                    alt="Logo">
                            </div>
                            <div class="leading-tight">
                                <p class="text-sm font-bold leading-tight">SIMANTA</p>
                                <p class="text-[11px] text-white/70 leading-tight">Sistem Informasi Manajemen Magang
                                    &amp; Tamu
                                </p>
                        ...
                        <div class="leading-tight min-w-0">
                            ...
                            <p class="text-[11px] text-white/70 truncate">Sistem Informasi Manajemen Magang &amp; Tamu
                            </p>
                        </div>
                    ...
                    <nav class="flex-1 overflow-y-auto px-4 py-5 space-y-2">
                        <a href="{{ $urlProfile }}" class="{{ $navItem($activeProfile) }}">
                            <span
                                class="h-9 w-9 rounded-2xl bg-white/10 border border-white/10 flex items-center justify-center transition group-hover:bg-white/15">
        ...
        <div x-show="sidebarOpen" x-transition.opacity @click="sidebarOpen = false"
            class="fixed inset-0 z-40 bg-black/40 sm:hidden" style="display:none;" aria-hidden="true"></div>
        ...
        <div class="h-[100dvh] min-h-0 overflow-hidden flex flex-col sm:pl-64">
            ...
            <header
                ...
                <div class="flex items-center gap-3">
                    <div
                        class="hidden md:flex items-center gap-2 rounded-2xl border border-white/15 bg-white/10 px-3 py-2">
