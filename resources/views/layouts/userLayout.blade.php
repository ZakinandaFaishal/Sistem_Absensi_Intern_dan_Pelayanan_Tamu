...
@php
    ...
    $activeScanQr  = request()->routeIs('attendance.qr') || request()->routeIs('attendance.scan.*') || request()->is('presensi/scan*');
    ...
    >
        <div class="flex h-full flex-col">
            ...
            <nav class="flex-1 overflow-y-auto px-4 py-5 space-y-2 text-sm">
                ...
                <a href="{{ $urlProfile }}"
                   class="{{ $itemClass($activeProfile) }}">
                    <span class="text-base">👤</span>
                    <span>Profil</span>
                </a>

                <a href="{{ $urlScanQr }}"
                   class="{{ $itemClass($activeScanQr) }}">
                    <span class="text-base">📷</span>
                    <span>Scan QR Presensi</span>
                </a>

                <a href="{{ $urlHistory }}"
                   class="{{ $itemClass($activeHistory) }}">
                    <span class="text-base">📌</span>
