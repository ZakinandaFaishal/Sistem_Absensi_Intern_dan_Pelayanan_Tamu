...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <section class="{{ $panel }}">
        ...
        <div class="relative p-6 sm:p-7">
            ...
            <div class="flex items-start justify-between gap-4">
                <div class="min-w-0">
                    ...
                    <div class="mt-4">
                        <span
                            id="geo-status"
                            class="inline-flex items-center gap-2 rounded-full border border-white/12 bg-white/7 px-3 py-1 text-xs font-semibold text-white/85"
                        >
            ...
            <div class="mt-5 h-px w-full bg-gradient-to-r from-transparent via-emerald-300/25 to-transparent"></div>
    ...
    <section class="{{ $panel }}">
        ...
        <form method="POST" action="{{ route('attendance.scan.store') }}" id="attendance-scan-form"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                {{-- Check-out (still green) --}}
                <button type="submit" name="action" value="out"
                    class="inline-flex items-center justify-center gap-2 rounded-2xl px-4 py-3
                           bg-teal-500/18 border border-teal-300/20 text-teal-50
                           text-sm font-semibold shadow
                           hover:bg-teal-500/28 transition
                           focus:outline-none focus:ring-2 focus:ring-teal-200/30
                           active:scale-[0.99]">
            ...
            <div class="flex flex-wrap items-center gap-2 pt-1">
                ...
                <a href="{{ route('dashboard') }}"
                    class="inline-flex items-center justify-center gap-2 rounded-xl
                           bg-white/7 px-4 py-2 text-sm font-semibold text-white/85
...
<script>
    (function () {
        ...
        function classesFor(variant) {
            ...
            // idle/loading (match profil)
            return base.concat(['border-white/12','bg-white/7','text-white/85']);
        }
        ...
        function getLocation() {
            ...
            setStatus('Meminta izin lokasi…', 'idle');
