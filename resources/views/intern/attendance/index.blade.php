...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <section class="relative rounded-3xl border border-white/15 bg-white/10 backdrop-blur-xl shadow-xl p-6 sm:p-7 overflow-hidden">
        ...
        <div class="relative mt-6 h-[2px] w-full rounded-full bg-gradient-to-r from-transparent via-white/30 to-transparent"></div>
    ...
    <section class="relative rounded-3xl border border-white/15 bg-white/10 backdrop-blur-xl shadow-xl overflow-hidden">
        ...
        <div class="relative px-6 py-5 border-b border-white/10">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div class="flex items-center gap-3">
                    <div class="h-10 w-10 rounded-2xl bg-white/15 border border-white/20 flex items-center justify-center">
                    ...
                    <tbody class="divide-y divide-white/10">
                        @forelse($attendances as $attendance)
                            <tr class="hover:bg-white/5 transition">
                                ...
                                <td class="py-3 pr-4 whitespace-nowrap">
                                    @if ($attendance->lat !== null && $attendance->lng !== null)
                                        <div class="inline-flex flex-col gap-1">
                                            <span class="inline-flex items-center rounded-full bg-white/10 px-3 py-1 text-xs font-semibold text-white/90 border border-white/15">
                                ...
                                <td class="py-3 pr-4 whitespace-nowrap">
                                    <span class="inline-flex rounded-lg bg-emerald-400/15 px-3 py-1 text-xs font-semibold text-emerald-200 border border-emerald-300/20">
                                        {{ $attendance->check_in_at?->format('H:i:s') ?? '-' }}
                                    </span>
                                </td>

                                <td class="py-3 pr-0 whitespace-nowrap">
                                    <span class="inline-flex rounded-lg bg-rose-400/15 px-3 py-1 text-xs font-semibold text-rose-200 border border-rose-300/20">
