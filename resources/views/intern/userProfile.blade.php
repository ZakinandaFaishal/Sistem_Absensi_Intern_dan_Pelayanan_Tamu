    ...
    <div class="max-w-6xl mx-auto space-y-6">
        ...
        <section
            ...
            <div class="relative p-6 sm:p-8">
                {{-- accent line --}}
                <div
                    class="mb-5 h-1 w-full rounded-full bg-gradient-to-r from-sky-400/60 via-fuchsia-400/50 to-emerald-400/55">
                </div>
                ...
                <div class="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                    <div class="min-w-0">
                        ...
                        <div class="mt-4 flex flex-wrap items-center gap-2">
                            <span
                                class="inline-flex items-center gap-2 rounded-full border px-3 py-1 text-xs font-semibold {{ $badge('neutral') }}">
                            ...
                            @if (($user->role ?? null) === 'intern')
                                <span
                                    ...
                                    <span
                                        class="h-1.5 w-1.5 rounded-full {{ $status === 'tamat' ? 'bg-emerald-400' : 'bg-sky-400' }}"></span>
                                    {{ $statusLabel }}
                                </span>
                            @endif
                        </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="relative">
                            <div
                                class="absolute inset-0 rounded-3xl bg-gradient-to-br from-sky-400/35 via-white/10 to-fuchsia-400/35 blur-lg">
                            </div>
                            <div
                ...
                <div class="mt-6 space-y-3">
                    @if (session('status'))
                        <div
                            class="rounded-2xl border border-emerald-300/20 bg-emerald-400/10 px-4 py-3 text-sm text-emerald-100 flex items-start gap-2">
        ...
        <section class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div
                class="relative overflow-hidden rounded-[22px] border border-white/12 bg-white/8 backdrop-blur-xl p-5 shadow-[0_14px_40px_rgba(0,0,0,.22)]">
            ...
            <div class="p-6 sm:p-8">
                <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
                    ...
                    <div class="flex items-center gap-2">
                        <span
                            class="inline-flex items-center gap-2 rounded-2xl border border-emerald-300/20 bg-emerald-400/10 px-3 py-2 text-xs font-semibold text-emerald-100">
                ...
                <div class="mt-6 grid grid-cols-1 lg:grid-cols-12 gap-4">
                    {{-- Identity card --}}
                    <div
                        class="lg:col-span-5 relative overflow-hidden rounded-[22px] border border-white/12 bg-white/8 p-5 sm:p-6">
                        <div class="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-sky-400/55 to-fuchsia-400/55"></div>

                        <div class="flex items-center gap-3">
                            <div
                                class="h-11 w-11 rounded-2xl bg-sky-400/10 border border-sky-300/20 flex items-center justify-center">
                    ...
                    {{-- Internship card --}}
                    <div
                        class="lg:col-span-7 relative overflow-hidden rounded-[22px] border border-white/12 bg-white/8 p-5 sm:p-6">
                        <div class="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-emerald-400/55 to-sky-400/55"></div>

                        <div class="flex items-center gap-3">
                            <div
                                class="h-11 w-11 rounded-2xl bg-emerald-400/10 border border-emerald-300/20 flex items-center justify-center">
                        ...
                        <div class="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="sm:col-span-2 rounded-2xl border border-white/10 bg-white/5 p-4">
                                ...
                                <p class="mt-1 text-sm font-semibold text-white break-words">{{ $internLocationLabel }}
                                </p>
