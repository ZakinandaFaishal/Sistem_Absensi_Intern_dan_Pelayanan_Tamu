    ...
    <div class="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
        ...
        <div class="p-6 space-y-3">
            @forelse($visits as $visit)
                ...
                <details class="group border border-slate-200 rounded-2xl bg-white hover:bg-slate-50/60 transition overflow-hidden">
                        ...
                        <div class="p-4 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                            <div class="min-w-0 space-y-2">
                                <div class="flex flex-wrap items-center gap-2">
                                    ...
                                    <span class="inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold {{ $statusPill }}">
                                        {{ $statusText }}
                                    </span>

                                    <span class="inline-flex items-center rounded-full border px-3 py-1 text-xs font-semibold {{ $visitPill }}">
                                    ...
                                    <span class="inline-flex items-center rounded-full border px-3 py-1 text-xs font-semibold {{ $servicePill }}">
                                ...
                                <div class="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-slate-500">
                                    ...
                                    @if ($visit->completed_at)
                                        <div>
                                            Selesai:
                                            <span class="font-semibold text-slate-700">{{ $visit->completed_at }}</span>
                                        </div>
                                    @endif
                            ...
                            <div class="p-4 sm:p-5 grid grid-cols-1 lg:grid-cols-2 gap-4">
                                <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                                    <div class="flex items-start justify-between gap-2">
                                        ...
                                        <span class="inline-flex items-center rounded-xl bg-white border border-slate-200 px-3 py-2 text-xs font-semibold text-slate-700">
                                ...
                                <div class="rounded-2xl border border-slate-200 bg-white p-4">
                                    <div class="flex items-center justify-between gap-2">
                                        ...
                                        <span class="inline-flex items-center rounded-xl bg-slate-100 px-3 py-2 text-xs font-semibold text-slate-700">
                                            🧾 Anggota
                                        </span>
                                    </div>
