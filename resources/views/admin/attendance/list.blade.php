        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            <div class="relative">
                ...
                <div id="menuExportAttendance"
                    class="hidden absolute right-0 mt-2 w-56 rounded-2xl border border-slate-200 bg-white shadow-xl overflow-hidden z-50">
                    <div class="px-4 py-3 border-b border-slate-100">
                        <p class="text-xs font-semibold text-slate-700">Pilih format</p>
                        <p class="mt-0.5 text-[11px] text-slate-500">Export mengikuti filter aktif.</p>
                    </div>

                    <button type="button"
                        class="export-attendance-action w-full text-left px-4 py-3 text-sm font-semibold text-slate-700
                               hover:bg-slate-50 transition flex items-center justify-between">
                        <span data-url="{{ route('admin.attendance.export.excel', request()->query()) }}" data-label="Excel"
                            class="pointer-events-none">Export Excel (Presensi)</span>
            ...
            <div class="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
                <div
                    ...
                    <div class="flex items-center gap-3">
                        <span class="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-slate-100 ring-1 ring-slate-200">
                ...
                <div class="p-6">
                        ...
                        <div class="md:col-span-4">
                            ...
                            <input name="q" value="{{ $filters['q'] ?? '' }}"
                                class="mt-1 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm
                                       shadow-sm shadow-slate-900/5 placeholder:text-slate-400
                    ...
                    @if (session('status'))
                        <div
                            class="mb-5 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-800 shadow-sm shadow-emerald-900/5">
                        ...
                        <table class="min-w-full text-sm">
                            <thead class="bg-slate-50">
                                <tr class="text-left text-slate-600 border-b border-slate-200">
                                    ...
                                    <th class="py-3 px-4 font-semibold">Akurasi</th>
                                </tr>
                            </thead>
