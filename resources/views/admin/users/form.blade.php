                ...
                <form method="POST"
                        ...
                        <div class="rounded-2xl border border-slate-200 bg-slate-50/40 p-4">
                            ...
                            <div class="mt-4 grid grid-cols-1 md:grid-cols-12 gap-4">
                                ...
                                <div id="userDinasFields"
                                    ...
                                    <p class="mt-1 text-xs text-slate-500">Wajib dipilih jika role <span class="font-semibold">admin_dinas</span>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="rounded-2xl border border-slate-200 bg-slate-50/40 p-4">
                                ...
                                <div class="mt-4 grid grid-cols-1 md:grid-cols-12 gap-4">
                                    <div class="md:col-span-4">
                                        ...
                                        <p class="mt-1 text-xs text-slate-500">Jika <span class="font-semibold">tamat</span>, user tidak bisa presensi lagi.</p>
                                    </div>
                    ...
                    <div class="md:col-span-12">
                        <div class="rounded-2xl border border-slate-200 bg-white p-4">
                            <div class="text-xs font-semibold text-slate-700">Keamanan Akun</div>
                            <div class="mt-0.5 text-xs text-slate-500">
                                {{ $editUser ? 'Kosongkan password jika tidak ingin mengubah.' : 'Wajib membuat password untuk akun baru.' }}
                            </div>

                            <div class="mt-4 grid grid-cols-1 md:grid-cols-12 gap-4">
                                <div class="md:col-span-6">
                                    <label class="block text-sm font-semibold text-slate-700">Password {{ $editUser ? '(Opsional)' : '' }}</label>
    ...
    <script>
        (function() {
            ...
            const sync = () => {
                ...
                if (dinasSelect) dinasSelect.required = (role === 'admin_dinas');
            };
