                        ...
                        <thead>
                            <tr class="text-left text-slate-600 border-b border-slate-200">
                                <th class="py-3 pr-4 font-semibold">
                                    <a href="{{ $sortUrl('name') }}" class="inline-flex items-center gap-2 hover:text-slate-900">
                                        Nama <span class="text-xs text-slate-400">{{ $sortIcon('name') }}</span>
                                    </a>
                                </th>
                                <th class="py-3 pr-4 font-semibold">
                                    <a href="{{ $sortUrl('username') }}" class="inline-flex items-center gap-2 hover:text-slate-900">
                                        Username <span class="text-xs text-slate-400">{{ $sortIcon('username') }}</span>
                                    </a>
                                </th>
                                <th class="py-3 pr-4 font-semibold">
                                    <a href="{{ $sortUrl('nik') }}" class="inline-flex items-center gap-2 hover:text-slate-900">
                                        NIK <span class="text-xs text-slate-400">{{ $sortIcon('nik') }}</span>
                                    </a>
                                </th>
                                <th class="py-3 pr-4 font-semibold">
                                    <a href="{{ $sortUrl('phone') }}" class="inline-flex items-center gap-2 hover:text-slate-900">
                                        No. Telepon <span class="text-xs text-slate-400">{{ $sortIcon('phone') }}</span>
                                    </a>
                                </th>
                                <th class="py-3 pr-4 font-semibold">
                                    <a href="{{ $sortUrl('email') }}" class="inline-flex items-center gap-2 hover:text-slate-900">
                                        Email <span class="text-xs text-slate-400">{{ $sortIcon('email') }}</span>
                                    </a>
                                </th>
                                <th class="py-3 pr-4 font-semibold">
                                    <a href="{{ $sortUrl('role') }}" class="inline-flex items-center gap-2 hover:text-slate-900">
                                        Role <span class="text-xs text-slate-400">{{ $sortIcon('role') }}</span>
                                    </a>
                                </th>
                                <th class="py-3 pr-4 font-semibold">
                                    <a href="{{ $sortUrl('active') }}" class="inline-flex items-center gap-2 hover:text-slate-900">
                                        Aktif <span class="text-xs text-slate-400">{{ $sortIcon('active') }}</span>
                                    </a>
                                </th>
                                <th class="py-3 pr-0 font-semibold text-right">
                                    <a href="{{ $sortUrl('created_at') }}" class="inline-flex items-center gap-2 hover:text-slate-900">
                                        Aksi <span class="text-xs text-slate-400">{{ $sortIcon('created_at') }}</span>
                                    </a>
                                </th>
                            </tr>
                        </thead>
